...
class ProfileEditorDialog extends StatelessWidget {
  ...
  ProfileEditorTabs _currentTab = ProfileEditorTabs.edit;
  ...
  void _saveEditing(BuildContext context) {
    ...
    bool success = true;
    String errMsg = '';
    ProfileDB.instance.setAboutMe(article!).then((value) {
      article = value;
    }).catchError((err) {
      '$err'.log();
      success = false;
  ...
  void _showImagePickerDialog({required BuildContext context, required String currentPath, void Function(String)? onPicked}) {
    ...
    var menuItemHeight = websiteImages.map((e) {
  ...
  Widget _getSideMenu(BuildContext context, {bool isIndependent = false}) {
    ...
    const items = ProfileEditorTabs.values;
        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Text(localization.name, style: const TextStyle(fontSize: 14, color: Colors.black)),
                ...
                const SizedBox(height: 20),
                Text(localization.selfIntroductionFormat, style: const TextStyle(fontSize: 14, color: Colors.black)),
                const SizedBox(height: 4),
                ...
                const SizedBox(height: 20),
                Text(localization.selfIntroduction, style: const TextStyle(fontSize: 14, color: Colors.black)),
                const SizedBox(height: 4),
                Stack(
                  children: [
                    TextField(
  ...
  Widget _getThemeTab(BuildContext context) {
    ...
    List<(String, String, dynamic Function(), void Function(dynamic))> themeColors = [
      (localization.profileBgColor, localization.profileBgColorDesc, () => Color(_customizedTheme.bgColor), (color) {
      ...
      (localization.profileFgColor, localization.profileFgColorDesc, () => Color(_customizedTheme.fgColor), (color) {
      ...
      (localization.profileBorderColor, localization.profileBorderColorDesc, () => Color(_customizedTheme.borderColor), (color) =>
      _customizedTheme.borderColor = color.value),
      (localization.profileNameBoxColor, localization.profileNameBoxColorDesc, () => Color(_customizedTheme.summaryBoxColor), (color) =>
      _customizedTheme.summaryBoxColor = color.value),
      (localization.profileNameBoxHoverColor, localization.profileNameBoxHoverColorDesc, () => Color(_customizedTheme.summaryBoxHoverColor), (color) =>
      _customizedTheme.summaryBoxHoverColor = color.value),
      (localization.profileNameTextColor, localization.profileNameTextColorDesc, () => Color(_customizedTheme.summaryTextColor), (color) =>
      _customizedTheme.summaryTextColor = color.value),
      (localization.profileContentBgColor, localization.profileContentBgColorDesc, () => Color(_customizedTheme.contentBgColor), (color) =>
      _customizedTheme.contentBgColor = color.value),
      (localization.profileContentTextColor, localization.profileContentTextColorDesc, () => Color(_customizedTheme.contentTextColor), (color) =>
      _customizedTheme.contentTextColor = color.value),
    ];
    List<(String, String, dynamic Function(), void Function(dynamic))> themeImages = [
      (localization.profilePicture, localization.profilePictureDesc, () => _customizedTheme.coverImage ?? '', (path) {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: switch (_currentTab) {
                          ProfileEditorTabs.edit => _getEditTab(context),
                          ProfileEditorTabs.theme => _getThemeTab(context),
                          ProfileEditorTabs.settings => _getSettingsTab(),
                        },
                      ),
                    ],
                  ),
...
extension on ProfileEditorTabs {
  String toLocalizedString(AppLocalizations localization) {
    switch (this) {
      case ProfileEditorTabs.edit:
        return localization.edit;
      case ProfileEditorTabs.theme:
        return localization.theme;
      case ProfileEditorTabs.settings:
